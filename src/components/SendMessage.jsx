...
const SendMessage = () => {
  ...
  return (
    <div className="bg-primary-dark fixed bottom-0 w-full py-10 shadow-lg">
      <form onSubmit={handleSendMessage} className="px-5 containerWrap flex">
        ...
        <button type="submit" className="w-auto bg-primary-light text-white rounded-r-lg px-5 text-xl">Send</button>
      </form>
    </div>
  )
}
